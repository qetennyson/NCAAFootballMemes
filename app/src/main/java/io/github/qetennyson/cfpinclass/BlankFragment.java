...
import static io.github.qetennyson.cfpinclass.R.*;
...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(layout.fragment_blank, container, false);

        ListView listViewTeams = (ListView) view.findViewById(id.listViewTeams);
